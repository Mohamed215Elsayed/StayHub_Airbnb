...
export class UserResponseDto {
  ...
  @ApiProperty({ example: '2026-08-11T10:30:00.000Z', description: 'Account creation timestamp' })
  @Expose()
  @Transform(({ value }) => {
  ...
  @ApiProperty({ example: '2026-08-11T10:35:00.000Z', description: 'Last update timestamp' })
  @Transform(({ value }) => {
    if (typeof value === 'string') return value;
    return value?.toISOString?.() ?? value;
  })
